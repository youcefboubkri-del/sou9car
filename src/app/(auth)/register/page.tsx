...
const perks = [
  ...
  "Touchez des acheteurs vérifiés partout au Maroc",
  "Protection escrow sur chaque transaction",
  "Historique du véhicule &amp; outils d'inspection",
];
        ...
        <div className="relative z-10">
          ...
          >
            <h2 className="text-4xl font-bold text-white mb-4 leading-tight">
              Vendez votre voiture.<br />Soyez payé en toute sécurité.
            </h2>
            <p className="text-white/40 text-lg mb-10">Créez votre compte en moins d&apos;une minute.</p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-white/40 text-sm mb-7">Rejoignez la marketplace auto de confiance au Maroc — gratuit</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-white/75 mb-1.5">Nom complet</label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className="block text-sm font-medium text-white/75 mb-1.5">
                  Téléphone <span className="text-white/40 font-normal">(optionnel)</span>
                </label>
                <input
                  type="tel"
                  value={phone}
            ...
            <p className="text-center text-xs text-white/40 mt-4">
              ...
              <Link href="/terms" className="text-orange-500 hover:underline">Conditions &amp; Confidentialité</Link>
            </p>

            <p className="text-center text-sm text-white/40 mt-4">
              Déjà un compte ?{" "}
              <Link href="/login" className="text-orange-500 font-semibold hover:text-orange-400">Se connecter</Link>
            </p>
          </motion.div>
        </div>
      </div>
